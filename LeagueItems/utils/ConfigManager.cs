...
/* Credit for this code goes to The Mystic Sword's MysticsRisky2Utils */
...
namespace LeagueItems
{
    public static class ConfigManager
    {
        ...
        {
            public static ConfigFile config = new(Paths.ConfigPath + "\\LeagueItems_Scaling.cfg", true);
            public static string categoryName = "LeagueItems Scaling";
            public static string categoryGUID = LeagueItemsPlugin.PluginGUID + "_scaling";
